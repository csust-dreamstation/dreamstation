		...
		<s:iterator value="#request.listMember" id="programmer"
			...
			<div class="programer">
				<div class="programer_image">
					<a target="_blank"  href="client_list_one_programer.action?member.id=<s:property value="#programmer.id" />"><img width="92px" height="126px" src="<s:property value="#programmer.image_small" />"/></a>
				</div>
				...
				<a target="_blank"  href="client_list_one_programer.action?member.id=<s:property value="#painting.id" />"><font face="微软雅黑" size="2px">详细资料&gt;&gt;</font></a>
				</div>
			</div>
		</s:iterator>
		</div>
