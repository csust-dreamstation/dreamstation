...
<body>
	<div class="body">
		<div class="nav">
			...
			<a href="list_front_image.action" target="_blank"><img src="image/border2.gif"></a>
		...
		<div class="news">
			<table width="500" border="0" align="center" cellpadding="1"
				...
				<s:iterator value="#request.list_news1" id="list_news">
					<script>
						marqueeContent[i] ='<a href="Find_News_By_Id.action?news.id=<s:property value="#list_news.id"/>" target="_blank"><font size="2px" color="#0099CC"; face="微软雅黑"><s:property value="#list_news.title"/></font></a>';
		...
		<div class="linkus">
			<a href="List_linkus.action" target="_blank"><font face=微软雅黑>联系我们</font>
			</a>
		</div>
			<div class="nav5">
		...
		<div class="nav2">
			<a href="http://blog.sina.com.cn/dreamstationblog" target="_blank"><font
				size="3px" color="#0099CC" face="微软雅黑">链接到团队博客 </font>
			</a>
		</div>
		</div>
		<div class="nav3">
			<a href="List_culture.action" target="_blank"><font size="2px"
				color="#0099CC" face="微软雅黑">团队文化</font></a>&nbsp;&nbsp;&nbsp;
				<a href="List_spirit.action" target="_blank"><font
				size="2px" color="#0099CC" face="微软雅黑">团队精神</font></a>&nbsp;&nbsp;&nbsp; 
				<a href="client_list_Page.action" target="_blank"><font
				size="2px" color="#0099CC" face="微软雅黑">科技前沿</font></a><br>

			<div class="nav4">
				<a href="client_page_action.action" target="_blank"><font size="2px"
					color="#0099CC" face="微软雅黑">留言版</font></a> &nbsp;&nbsp;<a href="admin_login.jsp" target="_blank"><font
					size="2px" color="#0099CC" face="微软雅黑">后台管理</font></a>
