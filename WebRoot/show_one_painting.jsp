...
<!-- Site Theme Styling -->
<link rel="stylesheet" href="css/show_one_painting.css" />
<style type="text/css">
body,html {
	width: 1004px;
	padding: 0px;
	...
	<div id="background">
			...
			<div class="painting_body">
					<div class="painting_image">
						<img width="400px" height="520px" src="<s:property value="%{member.image_big}"/>" />
					</div>
					...
					<div class="goback"><a href="client_list_all_painting.action?member.category='painting'"><font face="微软雅黑" size="2px">&lt;&lt;返回所有美工列表</font></a></div>
			</div>
			 <div class="copyright">
