    ...
    <body>
        ...
        <div id="background">
          ...
          <a href="list_info_to_index.action"><img src="image/border_11.gif"></a>
            ...
            <div class="content2">          
             <center><font face="楷体">梦之站文化</font></center>
         </div>
            ...
            <tr><td>
             <font face=微软雅黑>
           &nbsp;&nbsp;<s:property value="#culture.title" escape="false"/></font><br>
              ------------------------------------------------------------
            </td></tr>
            <tr><td>
            <font size="3px" face=微软雅黑>
      		<s:property value="#culture.content" escape="false"/>
      		</font><p>
      		</td></tr>
