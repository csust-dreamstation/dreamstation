...
<style type="text/css">
  ...
  <body>
   <div class="body">
		...
		<center>
		<table border=1 style="border-color: #EFF2FF">
	
		<tr><td>
		  项目名称：</td><td><input type="text" name="title" Style="width:450px;height:30px;resize:none "></td></tr>
		<tr><td> 项目开发者：</td><td><input type="text" name="developers" Style="width:450px;height:30px;resize:none "></td></tr>
		  <tr><td> 技术简介：</td><td><textarea type="text" name="technology" Style="width:450px;height:250px;resize:none "></textarea></tr>
		  <tr><td>  项目链接：</td><td><input type="text" name="link" Style="width:450px;height:30px;resize:none "></td></tr>
  		 ...
  		 <tr><td><input type="submit" name="上传"></td><td>
