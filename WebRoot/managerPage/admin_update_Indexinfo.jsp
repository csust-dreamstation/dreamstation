...
<style type="text/css">
  ...
  <div class="body">
		...
		<col class="even" />
				...
				<s:textarea name="id" rows="1" cols="10" value="%{index.id}"></s:textarea>	
					<tr><td>
						<s:textarea cssStyle="width:450px;height:30px;resize:none " name="pic_name" rows="1" cols="30"
							value="%{index.pic_name}" label="图片名称："></s:textarea></td></tr>
						<tr><td>
						<s:textarea name="pic_description" rows="1" cols="30"
							value="%{index.pic_description}" label="开发者：" cssStyle="width:450px;height:50px;resize:none "></s:textarea></td></tr>
						<tr><td>
