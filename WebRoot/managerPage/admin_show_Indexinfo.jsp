  ...
  <div class="body">
		...
		<col class="even" />
		  ...
		  <tr>
                              ...
                              <td width="50px" height="30px"class="head1">编号</td>
                   				<td width="200px" class="head2">图片名字</td>
                   				<td width="200px" class="head2">图片描述</td>
                   				<td width="200px" class="head2">图片地址</td>
                              <td width="50px" class="head1">删除</td>
                               <td width="50px" class="head2">更新</td>
                              </tr>
 	 <s:iterator value="#request.list_index" id="list_index" status="status">
                                 ...
                                 <td><s:property value="#list_index.id"/></td>
                           		...
                           		<td><s:property value="#list_index.pic_description"/></td>
