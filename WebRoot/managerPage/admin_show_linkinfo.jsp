...
<table cellspacing="0" align=center border="1" style="border-color: #EFF2FF">
		...
		<col class="odd" />
				...
				<tr>
					...
					<td class="head2" width="200px">电话</td>
					<td class="head1" width="50px">qq</td>
					<td class="head2" width="200px">邮箱</td>
					<td class="head1" width="200px">联系地址</td>
					<td class="head2" width="50px">删除</td>
					<td class="head1" width="50px">更新</td>
				</tr>
