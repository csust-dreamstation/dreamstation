...
<body>
	<div class="body">
		...
		<col class="even" />
				...
				<tr><td>
					<s:textarea name="id" rows="1" cols="10"
						value="%{member.id}" label="id" readonly="true" cssStyle="resize:none"></s:textarea>
				</td></tr>

					<tr><td>	
						<s:textarea name="name" rows="1" cols="30"
							value="%{member.name}" label="名     字" cssStyle="resize:none"></s:textarea></td></tr>
						<tr><td>
						<s:textarea name="introduction" rows="1" cols="30"
							value="%{member.introduction}" label="介     绍"  cssStyle="resize:none"></s:textarea></td></tr>
					<tr><td>     
						<s:textarea name="grade_major" rows="1" cols="30"
							value="%{member.grade_major}" label=" 年级专业"  cssStyle="resize:none"></s:textarea></td></tr>
						<tr><td>部&nbsp;&nbsp;门：</td>
